...
(function(w){
	...
	w[_namespace] = function(){
		...
		if( typeof WebUploader != 'undefined' && typeof _args.uploader != 'function' || _args.mup){
			//controller
			_imageUploader = _args.mup.create({
							auto: true, 
		...
		var _editorModuleEvents = {
			...
			insertImage: function(){
				if( typeof _args.mup === 'undefined' && typeof _args.uploader != 'function' ){
