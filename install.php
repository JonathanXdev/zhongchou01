<?php
if (!pdo_tableexists('yhzc_msg')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_msg')." (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  `uid` int(11) DEFAULT NULL,
  `title` varchar(64) DEFAULT NULL,
  `msg` varchar(100) DEFAULT NULL,
  `addtime` int(12) DEFAULT NULL,
  `status` tinyint(2) DEFAULT '0' COMMENT '0:未读，1:已读',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
    ");
}
if (!pdo_tableexists('yhzc_crowd')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd')." (
  `id` smallint(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) unsigned NOT NULL COMMENT '公众号ID',
  `u_id` int(11) DEFAULT '0' COMMENT '用户提交众筹的用户ID',
  `cid` smallint(5) unsigned NOT NULL,
  `ntype` tinyint(2) NOT NULL COMMENT '类型：0普通，1：联合',
  `team` tinyint(2) NULL DEFAULT 0 COMMENT '0：关闭，1：平台队伍，2,：平台&用户',
  `title` varchar(100) NOT NULL,
  `coverimg` varchar(400) NOT NULL DEFAULT '' COMMENT '封面图片',
  `summary` varchar(200) NOT NULL,
  `content` text NOT NULL,
  `money` decimal(11,2) NOT NULL DEFAULT '0.00',
  `cjmoney` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '已筹金额',
  `endmoney` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '结算金额',
  `ppnum` smallint(8) NOT NULL DEFAULT '0' COMMENT '参与人数',
  `addtime` int(11) unsigned NOT NULL,
  `starttime` int(11) NOT NULL,
  `endtime` int(11) NOT NULL,
  `gear` varchar(100) NOT NULL COMMENT '挡位：json格式，0为无档位',
  `auth` varchar(500) NOT NULL,
  `status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '状态：0待审核，1，已审核，-1：已关闭；2：已结算',
  `tags` varchar(64) NOT NULL COMMENT '关键字标签，格式：关键词,关键词',
  `nfrom` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '0：官方，1：个人，2：企业',
  `bmnum` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '限制报名人数',
  `bmlimit` smallint(8) DEFAULT '0' COMMENT '0：不限，',
  `bmstatus` tinyint(2) NOT NULL DEFAULT '0',
  `city` varchar(32) DEFAULT NULL,
  `viewnum` int(11) unsigned DEFAULT '0',
  `cjtype` tinyint(2) DEFAULT '0' COMMENT '0：筹满后停止，1：筹满后继续。',
  `taskst` tinyint(2) NULL COMMENT '任务蜘蛛是否来过',
  PRIMARY KEY (`id`),
  KEY `starttime` (`starttime`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC
  ");
}
if (!pdo_tableexists('yhzc_user')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_user')." (
`uid` int(11) NOT NULL,
	`uniacid` smallint(5) NULL,
	`openid` varchar(100) NULL,
	`name` varchar(32) NULL,
	`avatar` varchar(300) NULL,
	`phone` varchar(32) NULL,
	`phoneak` varchar(10) NULL,
	`xp` int(11) NULL,
	`money` decimal(11,2)  NULL DEFAULT 0,
...
if (!pdo_tableexists('yhzc_crowd_category')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd_category')." (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) NOT NULL,
  `name` varchar(64) NOT NULL,
  `content` varchar(100) NOT NULL,
  `icon` varchar(100) NULL,
  `norder` smallint(5) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
");
}
if (!pdo_tableexists('yhzc_crowd_march')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd_march')." (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  ...
  `nfrom` varchar(32) DEFAULT NULL,
  `ntype` tinyint(2) DEFAULT NULL COMMENT '0:官方，1：发起人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
");
}
if (!pdo_tableexists('yhzc_crowd_report')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd_report')." (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) NOT NULL,
  `crowd_id` int(11) NOT NULL,
  `union_id` int(11) NOT NULL DEFAULT '0' COMMENT '联合众筹报名ID',
  `user_id` int(11) NOT NULL COMMENT '微擎用户ID',
  `nickname` varchar(64) NOT NULL,
  `avatar` varchar(200) DEFAULT NULL,
  `openid` varchar(128) NOT NULL,
  `realname` varchar(64) NOT NULL,
  `money` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '支持金额',
  `wx_orderid` varchar(128) NOT NULL DEFAULT '0' COMMENT '微信订单号',
  `message` varchar(200) NOT NULL DEFAULT '' COMMENT '留言',
  `addtime` int(12) NOT NULL DEFAULT '0' COMMENT '下单时间',
  `paytime` int(12) NOT NULL DEFAULT '0' COMMENT '支付时间',
  `status` int(11) NOT NULL COMMENT '0：提交未支付，1：已支付，-1：已取消，-2：已退款',
  `reward_id` int(11) NOT NULL DEFAULT '0' COMMENT '支持回报ID',
  `reward_address_id` smallint(5) NOT NULL COMMENT '使用地址（实物回报需要）',
  `reward_other` varchar(128) NOT NULL DEFAULT '' COMMENT '回报额外信息',
  `reward_status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '回报状态0：未回报，1已回报',
  `reward_time` int(12) NOT NULL DEFAULT '0' COMMENT '回报处理时间',
  `reward_num` smallint(5) DEFAULT '1' COMMENT '购买份数',
  `paytype` tinyint(2) NULL DEFAULT '1' COMMENT '0:余额支付，1:微信支付',
  `info` varchar(32) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;");
}
if (!pdo_tableexists('yhzc_crowd_reward')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd_reward')." (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) NOT NULL DEFAULT '0',
  `crowd_id` int(11) NOT NULL DEFAULT '0',
  `reward_type` tinyint(2) NOT NULL DEFAULT '0',
  `reward_money` decimal(11,2) NOT NULL DEFAULT '0.00',
  `reward_title` varchar(64) NOT NULL DEFAULT '',
  `reward_content` varchar(200) NOT NULL DEFAULT '',
  `reward_limit` smallint(8) NOT NULL DEFAULT '0',
  `reward_count` smallint(8) DEFAULT '0',
  `reward_day` smallint(8) NOT NULL DEFAULT '0',
  `reward_fd` varchar(200) DEFAULT NULL,
  `reward_marknum` smallint(5) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
");
}
if (!pdo_tableexists('yhzc_crowd_union')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd_union')." (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) NOT NULL,
  `crowd_id` int(11) NOT NULL,
  ...
  `ppnum` smallint(8) NOT NULL,
  `sharenum` smallint(8) NOT NULL,
  `cjmoney` decimal(11,2) NOT NULL,
  `endmoney` decimal(11,2) NOT NULL,
...
if (!pdo_tableexists('yhzc_help')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_help')." (
    `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  `cid` smallint(5) DEFAULT NULL,
...
if (!pdo_tableexists('yhzc_help_category')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_help_category')." (
    `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  `name` varchar(32) DEFAULT NULL,
  `ndesc` varchar(80) DEFAULT NULL,
  `sort` smallint(5) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
    ");
}
if (!pdo_tableexists('yhzc_manage')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_manage')." (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
if (!pdo_tableexists('yhzc_manage_group')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_manage_group')." (
    `group_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) NOT NULL,
  `group_name` varchar(64) NOT NULL,
  `group_info` varchar(64) NOT NULL,
  PRIMARY KEY (`group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
    ");
}
if (!pdo_tableexists('yhzc_manage_role')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_manage_role')." (
    `role_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `role_name` varchar(64) NOT NULL,
  `role` varchar(100) NOT NULL,
  `role_info` varchar(64) NOT NULL,
  `uniacid` smallint(5) NOT NULL,
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
    ");
}
if (!pdo_tableexists('yhzc_money_log')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_money_log')." (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) NOT NULL,
  `user_id` int(11) NOT NULL,
  `order_id` varchar(128) NOT NULL,
  `money` decimal(11,2) NOT NULL,
  `ntype` tinyint(3) NOT NULL,
  `addtime` int(12) NOT NULL,
...
if (!pdo_tableexists('yhzc_paylog')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_paylog')." (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT '0',
  ...
  `follow` tinyint(2) DEFAULT NULL,
  `paytime` int(12) DEFAULT NULL,
...
if (!pdo_tableexists('yhzc_role')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_role')." (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `icon` varchar(32) NOT NULL,
  `mc` varchar(32) NOT NULL COMMENT '控制器',
  `mm` varchar(32) NOT NULL COMMENT '方法',
  `name` varchar(32) NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    ");
    pdo_query("insert into ".tablename('yhzc_role')." (`id`,`icon`,`mc`,`mm`,`name`,`display`,`pid`,`sort`) values
    ('1','','crowd','clist','众筹列表','1','19','0'),
('3','','crowd','reportlist','支持管理','0','19','0'),
('4','','crowd','rewardlist','回报管理','0','19','0'),
('5','','crowd','start','发起众筹','1','19','0'),
('6','','crowd','category','众筹分类','1','19','0'),
('7','','system','set','系统设置','1','22','0'),
('29','','system','layout','个性化设置','1','22','0'),
('8','','system','notice','公告管理','1','22','0'),
('9','','system','rule','入口管理','1','22','0'),
('13','','manage','mlist','管理员列表','1','20','5'),
('14','','manage','role','角色管理','1','20','4'),
('15','','manage','group','部门管理','1','20','3'),
('17','','manage','submanage','编辑管理','0','20','0'),
('19','glyphicon-list','crowd','','众筹管理','1','0','98'),
('20','glyphicon-user','manage','','管理员设置','1','0','96'),
('21','glyphicon-home','home','index','控制台','1','0','99'),
('22','glyphicon-cog','system','','系统管理','1','0','95'),
('23','','crowd','march','众筹进展管理','0','19','0'),
('24','glyphicon-question-sign','help','','帮助','1','0','94'),
('25','','help','category','帮助分类','1','24','0'),
('26','','help','article','帮助文章','1','24','0'),
('27','','crowd','check','众筹审核','1','19','0'),
('28','glyphicon-comment','comment','index','评论留言管理','1','0','97');
SET FOREIGN_KEY_CHECKS = 1;");
}

if (!pdo_tableexists('yhzc_statistics')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_statistics')." (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT '0',
  `pv` int(11) DEFAULT '0' COMMENT '访问次数',
  `report` int(11) DEFAULT '0' COMMENT '支持次数',
  `cjmoney` float(11,2) DEFAULT '0.00' COMMENT '筹集金额',
  `addtime` int(12) NOT NULL COMMENT '时间',
  PRIMARY KEY (`id`,`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
    ");
}
if (!pdo_tableexists('yhzc_sys_notice')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_sys_notice')." (
    `id` smallint(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(11) NOT NULL DEFAULT '0',
  `title` varchar(64) NOT NULL,
  `content` varchar(200) NOT NULL,
  `addtime` int(11) NOT NULL,
  `ntype` tinyint(2) NOT NULL DEFAULT '0',
  `nfrom` tinyint(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
    ");
}
if (!pdo_tableexists('yhzc_sys_rule')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_sys_rule')." (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  `name` varchar(32) DEFAULT NULL,
...
if (!pdo_tableexists('yhzc_system')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_system')." (
      `key` varchar(16) NOT NULL,
      `value` text NOT NULL,
      `uniacid` smallint(5) NOT NULL,
      `ntype` tinyint(2) DEFAULT '0' COMMENT '0:基础，1：单独',
      `info` varchar(32) NOT NULL
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

    ");
}
if (!pdo_tableexists('yhzc_user_collect')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_user_collect')." (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  `u_id` int(11) DEFAULT NULL,
  `bsid` int(11) DEFAULT NULL,
  `nfrom` tinyint(5) DEFAULT NULL COMMENT '0：普通，1：众筹，2：联合众筹',
  `title` varchar(64) DEFAULT NULL COMMENT '收藏标题',
  `link` varchar(100) DEFAULT NULL COMMENT '收藏链接',
  `addtime` int(12) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
    ");
}
if (!pdo_tableexists('yhzc_user_address')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_user_address')." (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
  ...
  `other` varchar(128) NOT NULL COMMENT '其他',
  `zipcode` varchar(32) NOT NULL COMMENT '邮编',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
    ");
}
if (!pdo_tableexists('yhzc_crowd_cache')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd_cache')." (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
    `uniacid` smallint(5) DEFAULT NULL,
  `u_id` int(11) DEFAULT NULL,
  `ntype` tinyint(2) DEFAULT '0' COMMENT '0:普通：1：联合',
  `default_info` text,
  `crowd_info` text,
  `crowd_content` text,
  `crowd_reward` text,
  `crowd_id` int(11) DEFAULT '0',
  `addtime` int(12) DEFAULT NULL,
  `lasttime` int(12) DEFAULT NULL,
  `status` tinyint(2) DEFAULT '0' COMMENT '0：编辑状态，1：审核中，2：审核完成；-1：适合失败',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
    ");
}
if (!pdo_tableexists('yhzc_crowd_team')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_crowd_team')." (
	`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `crowd_id` int(11) DEFAULT NULL,
  `uid` int(11) DEFAULT '0' COMMENT '0:平台增加，1：发起人增加',
  ...
  `addtime` int(12) DEFAULT NULL,
  `lasttime` int(12) DEFAULT NULL,
  `status` tinyint(2) DEFAULT NULL COMMENT '0:筹备，1：允许加入，-1不允许加入',
	PRIMARY KEY (`id`)
) ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci;
");
}
if (!pdo_tableexists('yhzc_smslog')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_smslog')." (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) DEFAULT NULL,
  `uid` int(11) DEFAULT NULL,
  `code` varchar(8) DEFAULT NULL,
  `addtime` int(12) DEFAULT NULL,
  `nfrom` tinyint(2) DEFAULT NULL COMMENT '0:绑定手机验证码',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
    ");
}
if (!pdo_tableexists('yhzc_comments')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_comments')." (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `vfrom` varchar(32) DEFAULT NULL,
  ...
  `content` text,
  `addtime` int(12) DEFAULT NULL,
  `likenum` smallint(5) DEFAULT NULL,
...
if (!pdo_tableexists('yhzc_area')) {
    pdo_query("CREATE TABLE ".tablename('yhzc_area')." (
`area_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '地区Id',
  ...
  KEY `area_name` (`area_name`)
    ...
    ");
    pdo_query("
    INSERT INTO ".tablename('yhzc_area')." (`area_id`, `area_code`, `area_name`, `level`, `city_code`, `center`, `parent_id`) VALUES  
